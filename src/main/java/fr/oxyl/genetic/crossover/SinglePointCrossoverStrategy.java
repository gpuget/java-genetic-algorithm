...
public class SinglePointCrossoverStrategy<T, U extends Individual<T>> extends AbtractCrossoverStrategy<T, U> {

  public SinglePointCrossoverStrategy(Recombiner<T> recombiner,
